<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/371736161/23.1.2%2B)
...
<!-- default badges end -->
# BI Dashboard for ASP.NET Core - How to access API of underlying widgets
